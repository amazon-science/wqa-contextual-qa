...
- [1] Ivano Lauriola and Alessandro Moschitti: *"Answer sentence selection using local and global context in transformer models"*, ECIR 2021.
- [2] Rujun Han, Luca Soldaini, and Alessandro Moschitti: *"Modeling Context in Answer Sentence Selection Systems on a Latency Budget"*, EACL 2021.
